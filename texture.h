...
bool LTexture::loadFromRenderedText(std::string textureText, SDL_Color textColor)
{
	...
	//Render text surface
	SDL_Surface *textSurface = TTF_RenderText_Solid(app.gFont, textureText.c_str(), textColor);
	if (textSurface != NULL)
	{
		//Create texture from surface pixels
		mTexture = SDL_CreateTextureFromSurface(app.gRenderer, textSurface);
		if (mTexture == NULL)
		{
...
void LTexture::render(int x, int y, SDL_Rect *clip, double angle, SDL_Point *center, SDL_RendererFlip flip)
{
	...
	//Render to screen
	SDL_RenderCopyEx(app.gRenderer, mTexture, clip, &renderQuad, angle, center, flip);
}
...
void LButton::render()
{
	...
	gButtonSpriteSheetTexture.render(mPosition.x, mPosition.y, &rect.gSpriteClips[mCurrentSprite]);
}
